    ...
    return (
      <div className="max-w-[1920px] w-full mx-auto">
        <div className="flex flex-col lg:flex-row justify-around p-4 md:p-10 gap-10">
          <div className="w-full lg:w-1/2 h-[600px] bg-gray-100 dark:bg-gray-800 animate-pulse rounded"></div>
          <div className="w-full lg:w-1/2 space-y-6">
            <div className="h-8 bg-gray-100 dark:bg-gray-800 animate-pulse rounded"></div>
            <div className="h-12 bg-gray-100 dark:bg-gray-800 animate-pulse rounded"></div>
