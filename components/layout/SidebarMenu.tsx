        ...
        <nav className="flex flex-col px-4 py-6 space-y-2 text-xl sm:text-2xl md:text-3xl">
              ...
              {categories.map((cat) => (
                <div key={cat.id} className="flex flex-col">
                  ...
                  {openCategoryId === cat.id && cat.subcategories && (
                    <div className="flex flex-col pl-6 mt-1 space-y-1 text-lg sm:text-xl">
          ...
          <div className="mt-6 pt-4 border-t border-stone-300 dark:border-stone-700 space-y-4 text-base sm:text-lg">
            <div className="flex items-center justify-between">
              <span className="opacity-80">{messages.header.currencyLabel}</span>
            ...
            <div className="flex items-center justify-between">
              <span className="opacity-80">{messages.header.languageLabel}</span>
              <div className="flex items-center gap-2">
                {["uk", "de", "en"].map((lng) => (
                  <button
                    key={lng}
