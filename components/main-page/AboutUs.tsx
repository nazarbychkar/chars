export default function AboutUs() {
  return (
    ...
    >
      {/* Title */}
      <div className="text-neutral-700 lg:text-[#8C7461] text-center text-2xl lg:text-5xl font-medium lg:font-normal lg:font-['Inter'] uppercase">
        Про нас
      </div>

      {/* Text Block */}
      <div className="max-w-[90%] lg:w-[1743px] text-center text-sm lg:text-3xl font-normal lg:font-['Inter'] leading-snug lg:leading-13 text-stone-900">
